...
class GameHelperUtils {
    ...
    private static final int[] RES_IDS = new int[]{C0455R.string.gamehelper_unknown_error, C0455R.string.gamehelper_sign_in_failed, C0455R.string.gamehelper_app_misconfigured, C0455R.string.gamehelper_license_failed};
