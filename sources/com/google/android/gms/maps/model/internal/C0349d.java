...
public interface C0349d extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.d$a */
    public static abstract class C0777a extends Binder implements C0349d {

        /* renamed from: com.google.android.gms.maps.model.internal.d$a$a */
        private static class C0776a implements C0349d {
            private IBinder kn;
            ...
            /* renamed from: b */
            public boolean mo2127b(C0349d c0349d) throws RemoteException {
                boolean z = false;
        ...
        public static C0349d aE(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0349d)) ? new C0776a(iBinder) : (C0349d) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    isUnderground = mo2127b(C0777a.aE(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isUnderground) {
                        i = 1;
                    }
    ...
    /* renamed from: b */
    boolean mo2127b(C0349d c0349d) throws RemoteException;
