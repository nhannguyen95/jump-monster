...
public final class GroundOverlay {
    private final C0348c SP;

    public GroundOverlay(C0348c delegate) {
        this.SP = (C0348c) fq.m986f(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.SP.mo2107a(((GroundOverlay) other).SP);
