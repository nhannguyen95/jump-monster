...
public final class CameraPosition implements SafeParcelable {
    ...
    CameraPosition(int versionCode, LatLng target, float zoom, float tilt, float bearing) {
        fq.m983b((Object) target, (Object) "null camera target");
        boolean z = 0.0f <= tilt && tilt <= 90.0f;
        fq.m985b(z, (Object) "Tilt needs to be between 0 and 90 inclusive");
        this.xH = versionCode;
        this.target = target;
        this.zoom = zoom;
        this.tilt = tilt + 0.0f;
    ...
    public String toString() {
        return fo.m977e(this).m976a("target", this.target).m976a("zoom", Float.valueOf(this.zoom)).m976a("tilt", Float.valueOf(this.tilt)).m976a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        if (C0336v.iB()) {
            C0337a.m1270a(this, out, flags);
        } else {
            CameraPositionCreator.m1254a(this, out, flags);
        }
    }
}
