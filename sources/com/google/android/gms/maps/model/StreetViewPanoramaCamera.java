...
public class StreetViewPanoramaCamera implements SafeParcelable {
    ...
    public String toString() {
        return fo.m977e(this).m976a("zoom", Float.valueOf(this.zoom)).m976a("tilt", Float.valueOf(this.tilt)).m976a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        StreetViewPanoramaCameraCreator.m1263a(this, out, flags);
    }
}
