...
public interface C0316b extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.b$a */
    public static abstract class C0732a extends Binder implements C0316b {

        /* renamed from: com.google.android.gms.maps.internal.b$a$a */
        private static class C0731a implements C0316b {
            private IBinder kn;
        ...
        public static C0316b aa(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0316b)) ? new C0731a(iBinder) : (C0316b) queryLocalInterface;
        }
