...
import com.google.android.gms.maps.internal.C0322h.C0744a;

public interface ILocationSourceDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a */
    public static abstract class C0716a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a$a */
        private static class C0715a implements ILocationSourceDelegate {
            private IBinder kn;
            ...
            public void activate(C0322h listener) throws RemoteException {
        ...
        public static ILocationSourceDelegate ae(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0715a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(C0744a.ak(data.readStrongBinder()));
    ...
    void activate(C0322h c0322h) throws RemoteException;
