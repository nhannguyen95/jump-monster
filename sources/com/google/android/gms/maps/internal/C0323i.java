...
public interface C0323i extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.i$a */
    public static abstract class C0746a extends Binder implements C0323i {

        /* renamed from: com.google.android.gms.maps.internal.i$a$a */
        private static class C0745a implements C0323i {
            private IBinder kn;
        ...
        public static C0323i al(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0323i)) ? new C0745a(iBinder) : (C0323i) queryLocalInterface;
        }
