...
import com.google.android.gms.maps.internal.IGoogleMapDelegate.C0714a;

public interface IMapFragmentDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate$a */
    public static abstract class C0718a extends Binder implements IMapFragmentDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate$a$a */
        private static class C0717a implements IMapFragmentDelegate {
            private IBinder kn;
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    IGoogleMapDelegate ac = C0714a.ac(obtain2.readStrongBinder());
                    return ac;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public C0190d onCreateView(C0190d inflaterWrapper, C0190d containerWrapper, Bundle savedInstanceState) throws RemoteException {
            ...
            public void onInflate(C0190d activityWrapper, GoogleMapOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public static IMapFragmentDelegate af(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C0717a(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(C0575a.m1749K(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    C0190d onCreateView = onCreateView(C0575a.m1749K(data.readStrongBinder()), C0575a.m1749K(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    C0190d onCreateView(C0190d c0190d, C0190d c0190d2, Bundle bundle) throws RemoteException;

    void onDestroy() throws RemoteException;

    void onDestroyView() throws RemoteException;

    void onInflate(C0190d c0190d, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException;
