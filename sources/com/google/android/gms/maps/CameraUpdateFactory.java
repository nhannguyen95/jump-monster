...
public final class CameraUpdateFactory {
    ...
    /* renamed from: a */
    static void m1223a(ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
        if (Ro == null) {
            Ro = (ICameraUpdateFactoryDelegate) fq.m986f(iCameraUpdateFactoryDelegate);
        }
    }

    private static ICameraUpdateFactoryDelegate ie() {
        return (ICameraUpdateFactoryDelegate) fq.m983b(Ro, (Object) "CameraUpdateFactory is not initialized");
    }
