...
public final class StreetViewPanoramaOptions implements SafeParcelable {
    ...
    StreetViewPanoramaOptions(int versionCode, StreetViewPanoramaCamera camera, String panoId, LatLng position, Integer radius, byte userNavigationEnabled, byte zoomGesturesEnabled, byte panningGesturesEnabled, byte streetNamesEnabled, byte useViewLifecycleInFragment) {
        ...
        this.So = radius;
        this.Sm = panoId;
        this.Sp = C0315a.m1228a(userNavigationEnabled);
        this.RP = C0315a.m1228a(zoomGesturesEnabled);
        this.Sq = C0315a.m1228a(panningGesturesEnabled);
        this.Sr = C0315a.m1228a(streetNamesEnabled);
    ...
    byte it() {
        return C0315a.m1229c(this.Sp);
    }

    byte iu() {
        return C0315a.m1229c(this.Sq);
    }

    byte iv() {
        return C0315a.m1229c(this.Sr);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        StreetViewPanoramaOptionsCreator.m1226a(this, out, flags);
    }
