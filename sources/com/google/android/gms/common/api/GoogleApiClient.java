...
public interface GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context, ConnectionCallbacks connectedListener, OnConnectionFailedListener connectionFailedListener) {
            this(context);
            fq.m983b((Object) connectedListener, (Object) "Must provide a connected listener");
            this.AY.add(connectedListener);
            fq.m983b((Object) connectionFailedListener, (Object) "Must provide a connection failed listener");
        ...
        public <O extends HasOptions> Builder addApi(Api<O> api, O options) {
            fq.m983b((Object) options, (Object) "Null options are not permitted for this Api");
        ...
        public GoogleApiClient build() {
            return new C0548b(this.mContext, this.AS, eh(), this.AX, this.AY, this.AZ);
        }
        ...
        public Builder setHandler(Handler handler) {
            fq.m983b((Object) handler, (Object) "Handler must not be null");
    ...
    /* renamed from: a */
    <C extends C0123a> C mo1085a(C0125c<C> c0125c);

    /* renamed from: a */
    <A extends C0123a, T extends C0901b<? extends Result, A>> T mo1086a(T t);

    /* renamed from: b */
    <A extends C0123a, T extends C0901b<? extends Result, A>> T mo1087b(T t);
