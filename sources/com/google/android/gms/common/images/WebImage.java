...
public final class WebImage implements SafeParcelable {
    public static final Creator<WebImage> CREATOR = new C0143b();
    ...
    public WebImage(JSONObject json) throws IllegalArgumentException {
        this(m1690d(json), json.optInt("width", 0), json.optInt("height", 0));
    }

    /* renamed from: d */
    private static Uri m1690d(JSONObject jSONObject) {
        Uri uri = null;
