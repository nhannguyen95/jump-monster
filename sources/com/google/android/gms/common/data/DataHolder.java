...
public final class DataHolder implements SafeParcelable {
    ...
    public static class Builder {
        ...
        private Builder(String[] columns, String uniqueColumn) {
            this.BH = (String[]) fq.m986f(columns);
        ...
        /* renamed from: a */
        private void m138a(HashMap<String, Object> hashMap) {
        ...
        public Builder sort(String sortColumn) {
            ...
            if (!(this.BT && sortColumn.equals(this.BU))) {
                Collections.sort(this.BQ, new C0133a(sortColumn));
                et();
                this.BT = true;
                this.BU = sortColumn;
            }
    ...
    private static final class C0133a implements Comparator<HashMap<String, Object>> {
        private final String BV;

        C0133a(String str) {
            this.BV = (String) fq.m986f(str);
        }

        /* renamed from: a */
        public int m141a(HashMap<String, Object> hashMap, HashMap<String, Object> hashMap2) {
            Object f = fq.m986f(hashMap.get(this.BV));
            Object f2 = fq.m986f(hashMap2.get(this.BV));
            if (f.equals(f2)) {
                return 0;
            }
        ...
        public /* synthetic */ int compare(Object x0, Object x1) {
            return m141a((HashMap) x0, (HashMap) x1);
        }
    }
    ...
    public DataHolder(AbstractWindowedCursor cursor, int statusCode, Bundle metadata) {
        this(cursor.getColumnNames(), m1678a(cursor), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata) {
        this(builder.BH, m1679a(builder, -1), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata, int maxResults) {
        this(builder.BH, m1679a(builder, maxResults), statusCode, metadata);
    }
    ...
    public DataHolder(String[] columns, CursorWindow[] windows, int statusCode, Bundle metadata) {
        ...
        this.xH = 1;
        this.BH = (String[]) fq.m986f(columns);
        this.BJ = (CursorWindow[]) fq.m986f(windows);
        this.Ah = statusCode;
        this.BK = metadata;
        validateContents();
    }
    ...
    /* renamed from: a */
    private static CursorWindow[] m1678a(AbstractWindowedCursor abstractWindowedCursor) {
        int i;
    ...
    /* renamed from: a */
    private static CursorWindow[] m1679a(Builder builder, int i) {
        int size;
        int i2 = 0;
    ...
    public static Builder builder(String[] columns, String uniqueColumn) {
        fq.m986f(uniqueColumn);
        return new Builder(columns, uniqueColumn);
    }

    /* renamed from: e */
    private void m1680e(String str, int i) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        DataHolderCreator.m142a(this, dest, flags);
    }
}
