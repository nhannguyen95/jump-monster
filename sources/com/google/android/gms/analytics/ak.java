...
class ak {
    ...
    /* renamed from: N */
    public static Map<String, String> m42N(String str) {
    ...
    /* renamed from: O */
    public static String m43O(String str) {
    ...
    /* renamed from: a */
    public static double m44a(String str, double d) {
        if (str != null) {
            try {
    ...
    /* renamed from: a */
    static String m45a(Locale locale) {
    ...
    /* renamed from: a */
    public static void m46a(Map<String, String> map, String str, String str2) {
    ...
    /* renamed from: d */
    public static boolean m47d(String str, boolean z) {
