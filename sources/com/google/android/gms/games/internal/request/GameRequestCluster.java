...
public final class GameRequestCluster implements SafeParcelable, GameRequest {
    ...
    private void hn() {
        ...
        for (int i = 1; i < size; i++) {
            ...
            fb.m920a(gameRequest.getType() == gameRequest2.getType(), "All the requests must be of the same type");
            fb.m920a(gameRequest.getSender().equals(gameRequest2.getSender()), "All the requests must be from the same sender");
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        GameRequestClusterCreator.m572a(this, dest, flags);
    }
}
