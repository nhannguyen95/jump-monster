...
public class PopupManager {
    ...
    private static final class PopupManagerHCMR1 extends PopupManager implements OnAttachStateChangeListener, OnGlobalLayoutListener {
        ...
        public void mo1483g(View view) {
            ...
            if (view == null && (context instanceof Activity)) {
                ...
                GamesLog.m367g("PopupManager", "You have not specified a View to use as content view for popups. Falling back to the Activity content view which may not work properly in future versions of the API. Use setViewForPopups() to set your content view.");
                view = view2;
            }
            if (view != null) {
                m1982h(view);
            ...
            GamesLog.m368h("PopupManager", "No content view usable to display popups. Popups will not be displayed in response to this client's calls. Use setViewForPopups() to set your content view.");
        }
    ...
    /* renamed from: a */
    public static PopupManager m567a(GamesClientImpl gamesClientImpl, int i) {
    ...
    public void gS() {
        this.JK.m2777a(this.JL.JM, this.JL.gV());
    }
