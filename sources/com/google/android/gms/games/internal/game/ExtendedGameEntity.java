...
public final class ExtendedGameEntity extends GamesDowngradeableSafeParcel implements ExtendedGame {
    ...
    static final class ExtendedGameEntityCreatorCompat extends ExtendedGameEntityCreator {
        ...
        public ExtendedGameEntity aq(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m2861c(fe.eJ()) || fe.al(ExtendedGameEntity.class.getCanonicalName())) {
    ...
    /* renamed from: a */
    static int m3375a(ExtendedGame extendedGame) {
    ...
    /* renamed from: a */
    static boolean m3376a(ExtendedGame extendedGame, Object obj) {
    ...
    /* renamed from: b */
    static String m3377b(ExtendedGame extendedGame) {
        return fo.m977e(extendedGame).m976a("Game", extendedGame.getGame()).m976a("Availability", Integer.valueOf(extendedGame.gX())).m976a("Owned", Boolean.valueOf(extendedGame.gY())).m976a("AchievementUnlockedCount", Integer.valueOf(extendedGame.gZ())).m976a("LastPlayedServerTimestamp", Long.valueOf(extendedGame.ha())).m976a("PriceMicros", Long.valueOf(extendedGame.hb())).m976a("FormattedPrice", extendedGame.hc()).m976a("FullPriceMicros", Long.valueOf(extendedGame.hd())).m976a("FormattedFullPrice", extendedGame.he()).toString();
    }
    ...
    public String toString() {
        return m3377b((ExtendedGame) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ExtendedGameEntityCreator.m569a(this, dest, flags);
    }
}
