...
public final class GameEntity extends GamesDowngradeableSafeParcel implements Game {
    ...
    static final class GameEntityCreatorCompat extends GameEntityCreator {
        ...
        public GameEntity an(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m2861c(fe.eJ()) || fe.al(GameEntity.class.getCanonicalName())) {
    ...
    /* renamed from: a */
    static boolean m3279a(Game game, Object obj) {
    ...
    /* renamed from: b */
    static String m3280b(Game game) {
        return fo.m977e(game).m976a("ApplicationId", game.getApplicationId()).m976a("DisplayName", game.getDisplayName()).m976a("PrimaryCategory", game.getPrimaryCategory()).m976a("SecondaryCategory", game.getSecondaryCategory()).m976a("Description", game.getDescription()).m976a("DeveloperName", game.getDeveloperName()).m976a("IconImageUri", game.getIconImageUri()).m976a("IconImageUrl", game.getIconImageUrl()).m976a("HiResImageUri", game.getHiResImageUri()).m976a("HiResImageUrl", game.getHiResImageUrl()).m976a("FeaturedImageUri", game.getFeaturedImageUri()).m976a("FeaturedImageUrl", game.getFeaturedImageUrl()).m976a("PlayEnabledGame", Boolean.valueOf(game.gb())).m976a("InstanceInstalled", Boolean.valueOf(game.gd())).m976a("InstancePackageName", game.ge()).m976a("AchievementTotalCount", Integer.valueOf(game.getAchievementTotalCount())).m976a("LeaderboardCount", Integer.valueOf(game.getLeaderboardCount())).m976a("RealTimeMultiplayerEnabled", Boolean.valueOf(game.isRealTimeMultiplayerEnabled())).m976a("TurnBasedMultiplayerEnabled", Boolean.valueOf(game.isTurnBasedMultiplayerEnabled())).toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        GameEntityCreator.m361a(this, dest, flags);
    }
}
