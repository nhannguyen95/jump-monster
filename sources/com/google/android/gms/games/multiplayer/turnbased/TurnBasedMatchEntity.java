...
public final class TurnBasedMatchEntity implements SafeParcelable, TurnBasedMatch {
    ...
    /* renamed from: a */
    static int m2881a(TurnBasedMatch turnBasedMatch) {
    ...
    /* renamed from: a */
    static int m2882a(TurnBasedMatch turnBasedMatch, String str) {
    ...
    /* renamed from: a */
    static boolean m2883a(TurnBasedMatch turnBasedMatch, Object obj) {
    ...
    /* renamed from: b */
    static String m2884b(TurnBasedMatch turnBasedMatch) {
        return fo.m977e(turnBasedMatch).m976a("Game", turnBasedMatch.getGame()).m976a("MatchId", turnBasedMatch.getMatchId()).m976a("CreatorId", turnBasedMatch.getCreatorId()).m976a("CreationTimestamp", Long.valueOf(turnBasedMatch.getCreationTimestamp())).m976a("LastUpdaterId", turnBasedMatch.getLastUpdaterId()).m976a("LastUpdatedTimestamp", Long.valueOf(turnBasedMatch.getLastUpdatedTimestamp())).m976a("PendingParticipantId", turnBasedMatch.getPendingParticipantId()).m976a("MatchStatus", Integer.valueOf(turnBasedMatch.getStatus())).m976a("TurnStatus", Integer.valueOf(turnBasedMatch.getTurnStatus())).m976a("Description", turnBasedMatch.getDescription()).m976a("Variant", Integer.valueOf(turnBasedMatch.getVariant())).m976a("Data", turnBasedMatch.getData()).m976a("Version", Integer.valueOf(turnBasedMatch.getVersion())).m976a("Participants", turnBasedMatch.getParticipants()).m976a("RematchId", turnBasedMatch.getRematchId()).m976a("PreviousData", turnBasedMatch.getPreviousMatchData()).m976a("MatchNumber", Integer.valueOf(turnBasedMatch.getMatchNumber())).m976a("AutoMatchCriteria", turnBasedMatch.getAutoMatchCriteria()).m976a("AvailableAutoMatchSlots", Integer.valueOf(turnBasedMatch.getAvailableAutoMatchSlots())).m976a("LocallyModified", Boolean.valueOf(turnBasedMatch.isLocallyModified())).m976a("DescriptionParticipantId", turnBasedMatch.getDescriptionParticipantId()).toString();
    }

    /* renamed from: b */
    static String m2885b(TurnBasedMatch turnBasedMatch, String str) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    /* renamed from: c */
    static Participant m2886c(TurnBasedMatch turnBasedMatch, String str) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    /* renamed from: c */
    static ArrayList<String> m2887c(TurnBasedMatch turnBasedMatch) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
    ...
    public boolean equals(Object obj) {
        return m2883a((TurnBasedMatch) this, obj);
    }
    ...
    public Participant getParticipant(String participantId) {
        return m2886c(this, participantId);
    }

    public String getParticipantId(String playerId) {
        return m2885b(this, playerId);
    }
    ...
    public int getParticipantStatus(String participantId) {
        return m2882a((TurnBasedMatch) this, participantId);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        TurnBasedMatchEntityCreator.m581a(this, out, flags);
    }
}
