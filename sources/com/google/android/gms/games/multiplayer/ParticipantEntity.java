...
public final class ParticipantEntity extends GamesDowngradeableSafeParcel implements Participant {
    ...
    static final class ParticipantEntityCreatorCompat extends ParticipantEntityCreator {
        ...
        public ParticipantEntity av(Parcel parcel) {
            Object obj = 1;
            if (GamesDowngradeableSafeParcel.m2861c(fe.eJ()) || fe.al(ParticipantEntity.class.getCanonicalName())) {
    ...
    /* renamed from: a */
    static int m3387a(Participant participant) {
    ...
    /* renamed from: a */
    static boolean m3388a(Participant participant, Object obj) {
    ...
    /* renamed from: b */
    static String m3389b(Participant participant) {
        return fo.m977e(participant).m976a("ParticipantId", participant.getParticipantId()).m976a("Player", participant.getPlayer()).m976a(HttpResponseHeader.Status, Integer.valueOf(participant.getStatus())).m976a("ClientAddress", participant.gi()).m976a("ConnectedToRoom", Boolean.valueOf(participant.isConnectedToRoom())).m976a("DisplayName", participant.getDisplayName()).m976a("IconImage", participant.getIconImageUri()).m976a("IconImageUrl", participant.getIconImageUrl()).m976a("HiResImage", participant.getHiResImageUri()).m976a("HiResImageUrl", participant.getHiResImageUrl()).m976a("Capabilities", Integer.valueOf(participant.getCapabilities())).m976a("Result", participant.getResult()).toString();
    }
    ...
    public String toString() {
        return m3389b((Participant) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ParticipantEntityCreator.m577a(this, dest, flags);
    }
}
