...
import com.google.android.gms.tagmanager.da.C0404a;
...
class ca implements at {
    ...
    class C0384b extends SQLiteOpenHelper {
        final /* synthetic */ ca YL;
        private boolean vF;
        private long vG = 0;

        C0384b(ca caVar, Context context, String str) {
            this.YL = caVar;
            super(context, str, null, 1);
        }

        /* renamed from: a */
        private void m1398a(SQLiteDatabase sQLiteDatabase) {
        ...
        /* renamed from: a */
        private boolean m1399a(String str, SQLiteDatabase sQLiteDatabase) {
            Cursor cursor;
            Throwable th;
            Cursor cursor2 = null;
            try {
    ...
    class C0819a implements C0404a {
        final /* synthetic */ ca YL;
        ...
        /* renamed from: a */
        public void mo2276a(ap apVar) {
            this.YL.m2483v(apVar.cP());
        }

        /* renamed from: b */
        public void mo2277b(ap apVar) {
            this.YL.m2483v(apVar.cP());
            bh.m1387y("Permanent failure dispatching hitId: " + apVar.cP());
        }

        /* renamed from: c */
        public void mo2278c(ap apVar) {
            long kD = apVar.kD();
            if (kD == 0) {
                this.YL.m2481c(apVar.cP(), this.YL.Wv.currentTimeMillis());
            } else if (kD + 14400000 < this.YL.Wv.currentTimeMillis()) {
                this.YL.m2483v(apVar.cP());
                bh.m1387y("Giving up on failed hitId: " + apVar.cP());
            }
        }
    }
    ...
    ca(au auVar, Context context, String str, int i) {
        ...
        this.YK = auVar;
        this.Wv = gn.ft();
        this.YI = new C0384b(this, this.mContext, this.vA);
        this.YJ = new da(new DefaultHttpClient(), this.mContext, new C0819a(this));
        this.vC = 0;
        this.vD = i;
    }

    /* renamed from: L */
    private SQLiteDatabase m2475L(String str) {
        try {
    ...
    /* renamed from: c */
    private void m2481c(long j, long j2) {
        SQLiteDatabase L = m2475L("Error opening database for getNumStoredHits.");
        if (L != null) {
            ...
            try {
                ...
                bh.m1388z("Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + j);
                m2483v(j);
            }
        }
    }
    ...
    private void cV() {
        ...
        if (cX > 0) {
            List s = m2486s(cX);
            bh.m1387y("Store full, deleting " + s.size() + " hits to make room.");
            m2484a((String[]) s.toArray(new String[0]));
        }
    }

    /* renamed from: f */
    private void m2482f(long j, String str) {
        SQLiteDatabase L = m2475L("Error opening database for putHit");
        if (L != null) {
            ContentValues contentValues = new ContentValues();
            ...
            try {
                ...
                this.YK.mo2285r(false);
            } catch (SQLiteException e) {
                bh.m1388z("Error storing hit");
            }
        }
    }

    /* renamed from: v */
    private void m2483v(long j) {
        m2484a(new String[]{String.valueOf(j)});
    }

    /* renamed from: a */
    void m2484a(String[] strArr) {
        boolean z = true;
        if (strArr != null && strArr.length != 0) {
            SQLiteDatabase L = m2475L("Error opening database for deleteHits.");
            if (L != null) {
                try {
    ...
    public void bW() {
        bh.m1387y("GTM Dispatch running...");
        if (this.YJ.ch()) {
            List t = m2487t(40);
            if (t.isEmpty()) {
                bh.m1387y("...nothing to dispatch");
                this.YK.mo2285r(true);
                return;
            }
            this.YJ.mo2289d(t);
            if (kR() > 0) {
    ...
    int cW() {
        ...
        SQLiteDatabase L = m2475L("Error opening database for deleteStaleHits.");
        if (L == null) {
            return 0;
        }
    ...
    int cX() {
        ...
        if (L != null) {
            try {
                ...
                bh.m1388z("Error getting numStoredHits");
                if (cursor != null) {
                    cursor.close();
                }
            } catch (Throwable th) {
    ...
    /* renamed from: e */
    public void mo2280e(long j, String str) {
        cW();
        cV();
        m2482f(j, str);
    }
    ...
    int kR() {
        ...
        try {
            ...
            try {
                ...
                cursor = query;
                try {
                    bh.m1388z("Error getting num untried hits");
                    if (cursor == null) {
                        count = 0;
                    } else {
                        cursor.close();
    ...
    /* renamed from: s */
    List<String> m2486s(int i) {
        SQLiteException e;
        Throwable th;
        List<String> arrayList = new ArrayList();
        if (i <= 0) {
            bh.m1388z("Invalid maxHits specified. Skipping");
            return arrayList;
        }
        SQLiteDatabase L = m2475L("Error opening database for peekHitIds.");
        if (L == null) {
            return arrayList;
        }
        Cursor query;
        try {
            ...
            try {
                ...
                e = e2;
                try {
                    bh.m1388z("Error in peekHits fetching hitIds: " + e.getMessage());
                    if (query != null) {
                        query.close();
                    }
                    return arrayList;
    ...
    /* renamed from: t */
    public java.util.List<com.google.android.gms.tagmanager.ap> m2487t(int r16) {
        /*
        r15 = this;
    ...
    L_0x00aa:
        ...
        r1.m1369K(r4);	 Catch:{ SQLiteException -> 0x0112, all -> 0x0164 }
    L_0x00b8:
        r1 = r3 + 1;
    ...
    L_0x00cc:
        ...
        com.google.android.gms.tagmanager.bh.m1388z(r2);	 Catch:{ all -> 0x016c }
    ...
    L_0x00f4:
        ...
        com.google.android.gms.tagmanager.bh.m1388z(r1);	 Catch:{ SQLiteException -> 0x0112, all -> 0x0164 }
        goto L_0x00b8;
    L_0x0112:
        r1 = move-exception;
        r12 = r2;
    L_0x0114:
        ...
        com.google.android.gms.tagmanager.bh.m1388z(r1);	 Catch:{ all -> 0x015d }
