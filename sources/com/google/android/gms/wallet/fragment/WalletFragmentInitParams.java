...
public final class WalletFragmentInitParams implements SafeParcelable {
    public static final Creator<WalletFragmentInitParams> CREATOR = new C0435a();
    ...
    public final class Builder {
        ...
        public WalletFragmentInitParams build() {
            ...
            fq.m981a(z2, "Exactly one of MaskedWallet or MaskedWalletRequest is required");
            if (this.acQ.acO < 0) {
                z = false;
            }
            fq.m981a(z, "masked wallet request code is required and must be non-negative");
            return this.acQ;
        }
