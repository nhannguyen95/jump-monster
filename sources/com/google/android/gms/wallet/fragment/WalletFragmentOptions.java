...
public final class WalletFragmentOptions implements SafeParcelable {
    public static final Creator<WalletFragmentOptions> CREATOR = new C0436b();
    private int Ev;
    ...
    /* renamed from: a */
    public static WalletFragmentOptions m2603a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0076R.styleable.WalletFragmentOptions);
        ...
        walletFragmentOptions.acR.m2611I(context);
    ...
    /* renamed from: I */
    public void m2607I(Context context) {
        if (this.acR != null) {
            this.acR.m2611I(context);
        }
    }
