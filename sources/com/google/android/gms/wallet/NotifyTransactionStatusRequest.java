...
public final class NotifyTransactionStatusRequest implements SafeParcelable {
    public static final Creator<NotifyTransactionStatusRequest> CREATOR = new C0444m();
    String abh;
    String ach;
    int status;
    final int xH;
    ...
    public final class Builder {
        ...
        public NotifyTransactionStatusRequest build() {
            boolean z = true;
            fq.m985b(!TextUtils.isEmpty(this.aci.abh), (Object) "googleTransactionId is required");
            if (this.aci.status < 1 || this.aci.status > 8) {
                z = false;
            }
            fq.m985b(z, (Object) "status is an unrecognized value");
            return this.aci;
        }
