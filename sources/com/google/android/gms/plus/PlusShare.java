...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            fq.m981a(plusClient != null, "PlusClient must not be null.");
            fq.m981a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            fq.m981a(plusClient.iI().bg(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            fq.m981a(this.TZ, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            fq.m985b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                fq.m981a(PlusShare.bd(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            fq.m981a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            fq.m981a(z3, "The content URL is required for interactive posts.");
            ...
            fq.m981a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                fq.m981a(PlusShare.bd(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            fq.m985b(this.TZ, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            fq.m985b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m1297a(title, description, thumbnailUri);
    ...
    /* renamed from: a */
    public static Bundle m1297a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
