...
import com.google.android.gms.internal.gy.C0661a;
...
public class gw extends ff<gy> {
    ...
    public static final class C0978a extends C0659a {
        private final int CV;
        private Activity nS;

        public C0978a(int i, Activity activity) {
            this.CV = i;
            this.nS = activity;
        }
        ...
        /* renamed from: d */
        public void mo1772d(int i, Bundle bundle) {
    ...
    /* renamed from: R */
    protected gy m3060R(IBinder iBinder) {
        return C0661a.m2247T(iBinder);
    }

    /* renamed from: a */
    public void m3061a(UserAddressRequest userAddressRequest, int i) {
        hO();
        this.NA = new C0978a(i, this.nS);
        Bundle bundle;
        try {
            bundle = new Bundle();
            ...
            hN().mo1773a(this.NA, userAddressRequest, bundle);
        } catch (Throwable e) {
            Log.e("AddressClientImpl", "Exception requesting user address", e);
            bundle = new Bundle();
            bundle.putInt(Extras.EXTRA_ERROR_CODE, ErrorCodes.ERROR_CODE_NO_APPLICABLE_ADDRESSES);
            this.NA.mo1772d(1, bundle);
        }
    }

    /* renamed from: a */
    protected void mo2684a(fm fmVar, C0976e c0976e) throws RemoteException {
        fmVar.mo1748d(c0976e, GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE, getContext().getPackageName());
    }
