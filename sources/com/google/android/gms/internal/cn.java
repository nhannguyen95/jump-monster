...
public interface cn extends IInterface {
    ...
    public static abstract class C0611a extends Binder implements cn {

        /* renamed from: com.google.android.gms.internal.cn$a$a */
        private static class C0610a implements cn {
            private IBinder kn;
        ...
        /* renamed from: o */
        public static cn m2068o(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof cn)) ? new C0610a(iBinder) : (cn) queryLocalInterface;
        }
