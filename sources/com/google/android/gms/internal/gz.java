...
public interface gz extends IInterface {
    ...
    public static abstract class C0663a extends Binder implements gz {

        /* renamed from: com.google.android.gms.internal.gz$a$a */
        private static class C0662a implements gz {
            private IBinder kn;
        ...
        /* renamed from: V */
        public static gz m2248V(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof gz)) ? new C0662a(iBinder) : (gz) queryLocalInterface;
        }
