...
public final class dd {
    ...
    /* renamed from: a */
    public static cz m725a(Context context, cx cxVar, String str) {
        try {
            cz czVar;
            List list;
            List list2;
            ...
            if (TextUtils.isEmpty(optString4)) {
                if (TextUtils.isEmpty(optString2)) {
                    dw.m824z("Could not parse the mediation config: Missing required ad_html or ad_url field.");
                    return new cz(0);
                }
                cz a = dc.m2989a(context, cxVar.kK.rq, optString2);
                optString = a.ol;
                optString4 = a.pm;
                j = a.ps;
                czVar = a;
            } else if (TextUtils.isEmpty(optString)) {
                dw.m824z("Could not parse the mediation config: Missing required ad_base_url field");
                return new cz(0);
            } else {
                czVar = null;
            }
            ...
            dw.m824z("Could not parse the mediation config: " + e.getMessage());
            return new cz(0);
        }
    }

    /* renamed from: a */
    public static String m726a(cx cxVar, dg dgVar, Location location, String str) {
        try {
            ...
            if (cxVar.pg.versionCode >= 2 && cxVar.pg.lP != null) {
                m727a(hashMap, cxVar.pg.lP);
            }
            if (cxVar.versionCode >= 2) {
                hashMap.put("quality_signals", cxVar.pl);
            }
            if (dw.m819n(2)) {
                dw.m823y("Ad Request JSON: " + dq.m795p(hashMap).toString(2));
            }
            return dq.m795p(hashMap).toString();
        } catch (JSONException e) {
            dw.m824z("Problem serializing ad request to JSON: " + e.getMessage());
            return null;
        }
    }

    /* renamed from: a */
    private static void m727a(HashMap<String, Object> hashMap, Location location) {
    ...
    /* renamed from: a */
    private static void m728a(HashMap<String, Object> hashMap, ah ahVar) {
        String bx = dn.bx();
        if (bx != null) {
            hashMap.put("abf", bx);
        }
        ...
        if (ahVar.versionCode >= 2) {
            ...
            if (ahVar.lO != null) {
                m729a((HashMap) hashMap, ahVar.lO);
            }
        }
    ...
    /* renamed from: a */
    private static void m729a(HashMap<String, Object> hashMap, av avVar) {
        Object obj;
        Object obj2 = null;
        if (Color.alpha(avVar.mq) != 0) {
            hashMap.put("acolor", m732m(avVar.mq));
        }
        if (Color.alpha(avVar.backgroundColor) != 0) {
            hashMap.put("bgcolor", m732m(avVar.backgroundColor));
        }
        if (!(Color.alpha(avVar.mr) == 0 || Color.alpha(avVar.ms) == 0)) {
            hashMap.put("gradientto", m732m(avVar.mr));
            hashMap.put("gradientfrom", m732m(avVar.ms));
        }
        if (Color.alpha(avVar.mt) != 0) {
            hashMap.put("bcolor", m732m(avVar.mt));
        }
        ...
        if (Color.alpha(avVar.my) != 0) {
            hashMap.put("dcolor", m732m(avVar.my));
        }
        if (avVar.mz != null) {
            hashMap.put("font", avVar.mz);
        }
        if (Color.alpha(avVar.mA) != 0) {
            hashMap.put("hcolor", m732m(avVar.mA));
        }
    ...
    /* renamed from: a */
    private static void m730a(HashMap<String, Object> hashMap, dg dgVar) {
        hashMap.put("am", Integer.valueOf(dgVar.pZ));
        hashMap.put("cog", m731l(dgVar.qa));
        hashMap.put("coh", m731l(dgVar.qb));
        ...
        hashMap.put("ma", m731l(dgVar.qf));
        hashMap.put("sp", m731l(dgVar.qg));
    ...
    /* renamed from: l */
    private static Integer m731l(boolean z) {
        return Integer.valueOf(z ? 1 : 0);
    }

    /* renamed from: m */
    private static String m732m(int i) {
