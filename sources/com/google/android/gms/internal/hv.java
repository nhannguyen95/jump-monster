...
public interface hv extends IInterface {
    ...
    public static abstract class C0674a extends Binder implements hv {

        /* renamed from: com.google.android.gms.internal.hv$a$a */
        private static class C0673a implements hv {
            private IBinder kn;
            ...
            /* renamed from: a */
            public void mo1811a(hu huVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
        ...
        public static hv aM(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hv)) ? new C0673a(iBinder) : (hv) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo1811a(C0672a.aL(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    /* renamed from: a */
    void mo1811a(hu huVar, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
