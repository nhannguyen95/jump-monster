...
public interface ao extends IInterface {
    ...
    public static abstract class C0584a extends Binder implements ao {

        /* renamed from: com.google.android.gms.internal.ao$a$a */
        private static class C0583a implements ao {
            private IBinder kn;
        ...
        /* renamed from: e */
        public static ao m2008e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ao)) ? new C0583a(iBinder) : (ao) queryLocalInterface;
        }
