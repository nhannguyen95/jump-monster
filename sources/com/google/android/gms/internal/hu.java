...
public interface hu extends IInterface {
    ...
    public static abstract class C0672a extends Binder implements hu {

        /* renamed from: com.google.android.gms.internal.hu$a$a */
        private static class C0671a implements hu {
            private IBinder kn;
            ...
            /* renamed from: a */
            public void mo1810a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException {
        ...
        public static hu aL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hu)) ? new C0671a(iBinder) : (hu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo1810a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    /* renamed from: a */
    void mo1810a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException;
}
