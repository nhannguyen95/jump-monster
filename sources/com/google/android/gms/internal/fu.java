...
public class fu<K, V> {
    ...
    L_0x000a:
        monitor-enter(r4);
        r0 = r4.DL;	 Catch:{ all -> 0x002a }
        r0 = r0.get(r5);	 Catch:{ all -> 0x002a }
        if (r0 == 0) goto L_0x001b;
    L_0x0013:
        r1 = r4.DQ;	 Catch:{ all -> 0x002a }
        r1 = r1 + 1;
        r4.DQ = r1;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
    L_0x001a:
        return r0;
    L_0x001b:
        r0 = r4.DR;	 Catch:{ all -> 0x002a }
        r0 = r0 + 1;
        r4.DR = r0;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
        r1 = r4.create(r5);
    ...
    L_0x002d:
        monitor-enter(r4);
        r0 = r4.DO;	 Catch:{ all -> 0x0053 }
        r0 = r0 + 1;
        r4.DO = r0;	 Catch:{ all -> 0x0053 }
        r0 = r4.DL;	 Catch:{ all -> 0x0053 }
        r0 = r0.put(r5, r1);	 Catch:{ all -> 0x0053 }
        if (r0 == 0) goto L_0x0049;
    L_0x003c:
        r2 = r4.DL;	 Catch:{ all -> 0x0053 }
    ...
    L_0x0049:
        ...
        r3 = r4.m995c(r5, r1);	 Catch:{ all -> 0x0053 }
        r2 = r2 + r3;
    ...
    L_0x0056:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.fu.get(java.lang.Object):V");
    }
    ...
    public final V put(K key, V value) {
        ...
        synchronized (this) {
            this.DN++;
            this.size += m995c(key, value);
            put = this.DL.put(key, value);
            if (put != null) {
                this.size -= m995c(key, put);
            }
        }
        if (put != null) {
    ...
    L_0x0043:
        ...
        r3 = r4.m995c(r1, r0);	 Catch:{ all -> 0x0032 }
        r2 = r2 - r3;
