...
public final class an {
    ...
    public an(Context context, AttributeSet attributeSet) {
        int i = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0076R.styleable.AdsAttrs);
        ...
        if (i2 != 0 && r1 == 0) {
            this.lW = m618f(string);
        } else if (i2 == 0 && r1 != 0) {
            this.lW = m618f(string2);
        } else if (i2 == 0 || r1 == 0) {
    ...
    /* renamed from: f */
    private static AdSize[] m618f(String str) {
