...
public final class Affine2 implements Serializable {
    ...
    public Affine2 setToTranslation(Vector2 trn) {
        return setToTranslation(trn.f158x, trn.f159y);
    }
    ...
    public Affine2 setToScaling(Vector2 scale) {
        return setToScaling(scale.f158x, scale.f159y);
    }
    ...
    public Affine2 setToShearing(Vector2 shear) {
        return setToShearing(shear.f158x, shear.f159y);
    }
    ...
    public Affine2 setToTrnRotScl(Vector2 trn, float degrees, Vector2 scale) {
        return setToTrnRotScl(trn.f158x, trn.f159y, degrees, scale.f158x, scale.f159y);
    }
    ...
    public Affine2 setToTrnRotRadScl(Vector2 trn, float radians, Vector2 scale) {
        return setToTrnRotRadScl(trn.f158x, trn.f159y, radians, scale.f158x, scale.f159y);
    }
    ...
    public Affine2 setToTrnScl(Vector2 trn, Vector2 scale) {
        return setToTrnScl(trn.f158x, trn.f159y, scale.f158x, scale.f159y);
    }
    ...
    public Affine2 preMul(Affine2 other) {
        ...
        this.m00 = (other.m00 * this.m00) + (other.m01 * this.m10);
        this.m01 = tmp01;
        this.m02 = tmp02;
        this.m10 = tmp10;
        this.m11 = tmp11;
    ...
    public Affine2 translate(Vector2 trn) {
        return translate(trn.f158x, trn.f159y);
    }
    ...
    public Affine2 preTranslate(Vector2 trn) {
        return preTranslate(trn.f158x, trn.f159y);
    }
    ...
    public Affine2 scale(Vector2 scale) {
        return scale(scale.f158x, scale.f159y);
    }
    ...
    public Affine2 preScale(Vector2 scale) {
        return preScale(scale.f158x, scale.f159y);
    }
    ...
    public Affine2 preRotate(float degrees) {
        if (degrees != 0.0f) {
            float cos = MathUtils.cosDeg(degrees);
            float sin = MathUtils.sinDeg(degrees);
            float tmp01 = (this.m01 * cos) - (this.m11 * sin);
            float tmp02 = (this.m02 * cos) - (this.m12 * sin);
            float tmp10 = (this.m00 * sin) + (this.m10 * cos);
            float tmp11 = (this.m01 * sin) + (this.m11 * cos);
            float tmp12 = (this.m02 * sin) + (this.m12 * cos);
            this.m00 = (this.m00 * cos) - (this.m10 * sin);
            this.m01 = tmp01;
            this.m02 = tmp02;
            this.m10 = tmp10;
            this.m11 = tmp11;
    ...
    public Affine2 shear(float shearX, float shearY) {
        float tmp1 = this.m01 + (this.m00 * shearX);
        this.m00 += this.m01 * shearY;
        this.m01 = tmp1;
        tmp1 = this.m11 + (this.m10 * shearX);
        this.m10 += this.m11 * shearY;
        this.m11 = tmp1;
        return this;
    }

    public Affine2 shear(Vector2 shear) {
        return shear(shear.f158x, shear.f159y);
    }

    public Affine2 preShear(float shearX, float shearY) {
        float tmp01 = this.m01 + (this.m11 * shearX);
        float tmp02 = this.m02 + (this.m12 * shearX);
        float tmp10 = this.m10 + (this.m00 * shearY);
        float tmp11 = this.m11 + (this.m01 * shearY);
        float tmp12 = this.m12 + (this.m02 * shearY);
        this.m00 += this.m10 * shearX;
        this.m01 = tmp01;
        this.m02 = tmp02;
        this.m10 = tmp10;
        this.m11 = tmp11;
    ...
    public Affine2 preShear(Vector2 shear) {
        return preShear(shear.f158x, shear.f159y);
    }
    ...
    public Vector2 getTranslation(Vector2 position) {
        position.f158x = this.m02;
        position.f159y = this.m12;
        return position;
    }
    ...
    public void applyTo(Vector2 point) {
        float x = point.f158x;
        float y = point.f159y;
        point.f158x = ((this.m00 * x) + (this.m01 * y)) + this.m02;
        point.f159y = ((this.m10 * x) + (this.m11 * y)) + this.m12;
    }
