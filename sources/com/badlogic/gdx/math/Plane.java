...
public class Plane implements Serializable {
    ...
    public void set(Vector3 point1, Vector3 point2, Vector3 point3) {
        this.normal.set(point1).sub(point2).crs(point2.f163x - point3.f163x, point2.f164y - point3.f164y, point2.f165z - point3.f165z).nor();
        this.f66d = -point1.dot(this.normal);
    }
