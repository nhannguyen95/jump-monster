...
public final class MathUtils {
    ...
    /* renamed from: E */
    public static final float f65E = 2.7182817f;
    ...
    private static class Sin {
        ...
        static {
            ...
            for (i = 0; i < 360; i += 90) {
                table[((int) (((float) i) * MathUtils.degToIndex)) & 16383] = (float) Math.sin((double) (((float) i) * 0.017453292f));
            }
        }
    }
    ...
    public static float log(float a, float x) {
        return (float) (Math.log((double) x) / Math.log((double) a));
    }
