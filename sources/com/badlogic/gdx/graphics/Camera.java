...
public abstract class Camera {
    ...
    public void lookAt(Vector3 target) {
        lookAt(target.f163x, target.f164y, target.f165z);
    }
    ...
    public void rotateAround(Vector3 point, Vector3 axis, float angle) {
        ...
        translate(-this.tmpVec.f163x, -this.tmpVec.f164y, -this.tmpVec.f165z);
    }
    ...
    public Vector3 unproject(Vector3 screenCoords, float viewportX, float viewportY, float viewportWidth, float viewportHeight) {
        float x = screenCoords.f163x;
        float y = ((((float) Gdx.graphics.getHeight()) - screenCoords.f164y) - 1.0f) - viewportY;
        screenCoords.f163x = ((2.0f * (x - viewportX)) / viewportWidth) - 1.0f;
        screenCoords.f164y = ((2.0f * y) / viewportHeight) - 1.0f;
        screenCoords.f165z = (screenCoords.f165z * 2.0f) - 1.0f;
    ...
    public Vector3 project(Vector3 worldCoords, float viewportX, float viewportY, float viewportWidth, float viewportHeight) {
        ...
        worldCoords.f163x = (((worldCoords.f163x + 1.0f) * viewportWidth) / 2.0f) + viewportX;
        worldCoords.f164y = (((worldCoords.f164y + 1.0f) * viewportHeight) / 2.0f) + viewportY;
        worldCoords.f165z = (worldCoords.f165z + 1.0f) / 2.0f;
        return worldCoords;
    }
