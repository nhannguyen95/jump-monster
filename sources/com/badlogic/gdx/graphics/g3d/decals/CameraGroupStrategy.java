...
public class CameraGroupStrategy implements GroupStrategy, Disposable {
    ...
    /* renamed from: com.badlogic.gdx.graphics.g3d.decals.CameraGroupStrategy$2 */
    class C00622 implements Comparator<Decal> {
        final /* synthetic */ Camera val$camera;

        C00622(Camera camera) {
