...
public class DecalBatch implements Disposable {
    ...
    public void initialize(int size) {
        ...
        this.mesh = new Mesh(VertexDataType.VertexArray, false, size * 4, size * 6, new VertexAttribute(1, 3, ShaderProgram.POSITION_ATTRIBUTE), new VertexAttribute(4, 4, ShaderProgram.COLOR_ATTRIBUTE), new VertexAttribute(16, 2, "a_texCoord0"));
