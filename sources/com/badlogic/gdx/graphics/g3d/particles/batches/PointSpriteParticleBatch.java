    ...
    protected void flush(int[] offsets) {
        ...
        while (i$.hasNext()) {
            ...
            while (p < data.controller.particles.size) {
                ...
                this.vertices[CPU_POSITION_OFFSET + offset] = positionChannel.data[positionOffset + 0];
        ...
        this.renderable.mesh.setVertices(this.vertices, 0, this.bufferedParticlesCount * CPU_VERTEX_SIZE);
    }
