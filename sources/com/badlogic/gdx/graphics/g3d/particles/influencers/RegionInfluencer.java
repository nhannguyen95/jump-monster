...
public abstract class RegionInfluencer extends Influencer {
    ...
    public static class AspectTextureRegion {
        ...
        public void set(TextureRegion region) {
            this.f54u = region.getU();
            this.f55v = region.getV();
        ...
        public void set(AspectTextureRegion aspectTextureRegion) {
            this.f54u = aspectTextureRegion.f54u;
            this.f55v = aspectTextureRegion.f55v;
    ...
    public static class Animated extends RegionInfluencer {
        ...
        public void update() {
            ...
            while (i < c) {
                ...
                this.regionChannel.data[i + 0] = region.f54u;
                this.regionChannel.data[i + 1] = region.f55v;
    ...
    public static class Random extends RegionInfluencer {
        ...
        public void activateParticles(int startIndex, int count) {
            ...
            int c = i + (this.regionChannel.strideSize * count);
            while (i < c) {
    ...
    public RegionInfluencer() {
        ...
        aspectRegion.f55v = 0.0f;
        aspectRegion.f54u = 0.0f;
