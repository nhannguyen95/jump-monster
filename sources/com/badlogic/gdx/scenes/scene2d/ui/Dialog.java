...
public class Dialog extends Window {
    ...
    protected InputListener ignoreTouchDown = new C08691();
    ...
    class C08691 extends InputListener {
        C08691() {
        }
    ...
    class C08702 extends ChangeListener {
        C08702() {
        }
    ...
    class C08713 extends FocusListener {
        C08713() {
        }
    ...
    private void initialize() {
        ...
        this.buttonTable.addListener(new C08702());
        this.focusListener = new C08713();
    }
