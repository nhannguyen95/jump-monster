...
public class OrthogonalTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        int col1 = Math.max(0, (int) (this.viewBounds.f154x / layerTileWidth));
        int col2 = Math.min(layerWidth, (int) (((this.viewBounds.f154x + this.viewBounds.width) + layerTileWidth) / layerTileWidth));
        int row1 = Math.max(0, (int) (this.viewBounds.f155y / layerTileHeight));
        int row2 = Math.min(layerHeight, (int) (((this.viewBounds.f155y + this.viewBounds.height) + layerTileHeight) / layerTileHeight));
