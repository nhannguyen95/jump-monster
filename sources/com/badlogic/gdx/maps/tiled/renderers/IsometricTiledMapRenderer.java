...
public class IsometricTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    private Vector3 translateScreenToIso(Vector2 vec) {
        this.screenPos.set(vec.f158x, vec.f159y, 0.0f);
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        this.topRight.set(this.viewBounds.f154x + this.viewBounds.width, this.viewBounds.f155y);
        this.bottomLeft.set(this.viewBounds.f154x, this.viewBounds.f155y + this.viewBounds.height);
        this.topLeft.set(this.viewBounds.f154x, this.viewBounds.f155y);
        this.bottomRight.set(this.viewBounds.f154x + this.viewBounds.width, this.viewBounds.f155y + this.viewBounds.height);
        int row1 = ((int) (translateScreenToIso(this.topLeft).f164y / tileWidth)) - 2;
        int row2 = ((int) (translateScreenToIso(this.bottomRight).f164y / tileWidth)) + 2;
        int col1 = ((int) (translateScreenToIso(this.bottomLeft).f163x / tileWidth)) - 2;
        int col2 = ((int) (translateScreenToIso(this.topRight).f163x / tileWidth)) + 2;
