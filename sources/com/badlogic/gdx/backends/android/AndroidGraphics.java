...
public class AndroidGraphics implements Graphics, Renderer {
    ...
    protected View createGLSurfaceView(AndroidApplicationBase application, ResolutionStrategy resolutionStrategy) {
        if (checkGL20()) {
            ...
            if (VERSION.SDK_INT > 10 || !this.config.useGLSurfaceView20API18) {
                ...
                view = new GLSurfaceView20API18(application.getContext(), resolutionStrategy);
                if (configChooser != null) {
                    view.setEGLConfigChooser(configChooser);
                } else {
                    view.setEGLConfigChooser(this.config.f34r, this.config.f33g, this.config.f32b, this.config.f31a, this.config.depth, this.config.stencil);
    ...
    protected EGLConfigChooser getEglConfigChooser() {
        return new GdxEglConfigChooser(this.config.f34r, this.config.f33g, this.config.f32b, this.config.f31a, this.config.depth, this.config.stencil, this.config.numSamples);
    }
    ...
    public void setContinuousRendering(boolean isContinuous) {
        if (this.view != null) {
            int renderMode;
            boolean z = enforceContinuousRendering || isContinuous;
            this.isContinuous = z;
