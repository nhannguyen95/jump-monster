...
import com.badlogic.gdx.backends.android.surfaceview.GLSurfaceViewAPI18.EGLContextFactory;
...
public class GLSurfaceView20API18 extends GLSurfaceViewAPI18 {
    ...
    private static class ConfigChooser implements EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            Log.w(GLSurfaceView20API18.TAG, String.format("%d configurations", new Object[]{Integer.valueOf(configs.length)}));
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        if (outAttrs != null) {
            outAttrs.imeOptions |= DriveFile.MODE_READ_ONLY;
        }
