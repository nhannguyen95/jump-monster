...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00151();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C04582();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00151 implements ThreadFactory {
    ...
    class C04582 extends WorkerRunnable<Params, Result> {
        C04582() {
            super();
        }
