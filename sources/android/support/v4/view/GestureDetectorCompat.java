...
public class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplJellybeanMr1 implements GestureDetectorCompatImpl {
        ...
        public GestureDetectorCompatImplJellybeanMr1(Context context, OnGestureListener listener, Handler handler) {
    ...
    public GestureDetectorCompat(Context context, OnGestureListener listener, Handler handler) {
        if (VERSION.SDK_INT >= 17) {
            this.mImpl = new GestureDetectorCompatImplJellybeanMr1(context, listener, handler);
        } else {
