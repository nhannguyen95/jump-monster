...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C00011();
        final Bundle mState;
    ...
    class C04561 implements FragmentContainer {
        C04561() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C04561(), this);
    }
